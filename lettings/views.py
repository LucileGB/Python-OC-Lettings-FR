...
def letting(request, letting_id):
    ...
    pretium, purus urna vulputate arcu, vitae efficitur lacus justo nec purus.
    Aenean finibus faucibus lectus at porta. Maecenas auctor, est ut luctus
    congue, dui enim mattis enim, ac condimentum velit libero in magna.
